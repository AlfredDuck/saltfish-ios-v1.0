...
@interface commentVC : UIViewController <UITableViewDelegate, UITableViewDataSource, UIActionSheetDelegate, writeCommentViewControllerDelegate, SFThirdLoginViewControllerDelegate>
// 文章id
